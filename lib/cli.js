 ...
 */
const writeOutput = (path, [iports, eports]) => (0, future_1.doFuture)(function* () {
    let ts = '';
    if (yield (0, file_1.isFile)(path)) {
        let contents = yield (0, file_1.readTextFile)(path);
        contents = contents.replace(exports.TDC_MERGE_IMPORTS, iports);
        contents = contents.replace(exports.TDC_MERGE_EXPORTS, eports);
        ts = contents;
    }
    else {
