 ...
 */
exports.startTemplate = (opts) => getMainImport(opts) +
 ...
 */
exports.isModule = (path) => future_1.doFuture(function* () {
 ...
 * exec the program.
 */
exports.exec = (path, opts) => future_1.doFuture(function* () {
 ...
 */
exports.getTDCFiles = (path) => future_1.doFuture(function* () {
 ...
 * @private
 */
exports.compile = ([conf, routes], opts, path) => future_1.doFuture(function* () {
 ...
 */
exports.execR = (path, opts) => file_1.listDirsAbs(path)
 ...
 */
exports.writeIndexFile = (path, ts) => file_1.writeTextFile(`${path}/${exports.FILE_INDEX}`, ts);
/**
 * writeStartFile writes out the start script to a destination/
 */
exports.writeStartFile = (path, opts) => file_1.writeTextFile(`${path}/${exports.FILE_START}`, exports.startTemplate(opts));
