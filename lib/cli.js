...
exports.writeStartFile = exports.writeIndexFile = exports.execR = exports.compile = exports.getTDCFiles = exports.exec = exports.isModule = exports.startTemplate = exports.args2Opts = exports.TDC_MERGE_COMMENT = exports.DEFAULT_MAIN = exports.FILE_START = exports.FILE_INDEX = exports.FILE_ROUTE = exports.FILE_CONF = void 0;
...
exports.TDC_MERGE_COMMENT = '/*tdc-output*/';
...
const compile = ([conf, routes], opts, path) => (0, future_1.doFuture)(function* () {
    ...
    return (0, future_1.pure)(combinedCode);
});
 ...
 */
const writeIndexFile = (path, ts) => (0, future_1.doFuture)(function* () {
    let indexFile = `${path}/${exports.FILE_INDEX}`;
    if (yield (0, file_1.isFile)(indexFile)) {
        let contents = yield (0, file_1.readTextFile)(indexFile);
        ts = ts.replace(exports.TDC_MERGE_COMMENT, contents);
    }
    return (0, file_1.writeTextFile)(indexFile, ts);
});
exports.writeIndexFile = writeIndexFile;
/**
 * writeStartFile writes out the start script to a destination/
 */
const writeStartFile = (path, opts) => (0, file_1.writeTextFile)(`${path}/${exports.FILE_START}`, (0, exports.startTemplate)(opts));
