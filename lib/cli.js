...
exports.writeStartFile = exports.writeIndexFile = exports.execR = exports.getTDCFiles = exports.exec = exports.isModule = exports.startTemplate = exports.args2Opts = exports.DEFAULT_MAIN = exports.FILE_START = exports.FILE_INDEX = exports.FILE_ROUTE = exports.FILE_CONF = void 0;
    ...
    return future_1.doFuture(function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    files = _a.sent();
                    return [4 /*yield*/, compile(files, opts, path)];
                case 8:
                    ts = _a.sent();
...
var compile = function (_a, opts, path) {
    var conf = _a[0], routes = _a[1];
    return future_1.doFuture(function () {
        var ctx, rclTS, jconTS, finalTS;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    conf = transform_1.ensureID(conf, path_1.dirname(path));
                    ctx = context(path);
                    return [4 /*yield*/, rcl.file2TS(ctx, routes)];
                case 1:
                    rclTS = _a.sent();
                    return [4 /*yield*/, jcon.compile(ctx, addCreate(addRoutes(conf, rclTS)))];
                case 2:
                    jconTS = _a.sent();
                    finalTS = [
                    ...
                    return [2 /*return*/, future_1.pure(finalTS)];
            }
        });
    });
};
    ...
    return isIgnored(opts, path) ?
        ...
        exports.isModule(path)
            ...
            exports.getTDCFiles(path)
                .chain(function (files) { return compile(files, opts, path); })
