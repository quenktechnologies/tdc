...
exports.value2TS = exports.file2TS = exports.flattenImports = exports.getAllImports = exports.wrapDirectives = exports.flattenCodeStruct = exports.parseJCONFile = exports.compile = exports.parse = exports.newContext = void 0;
...
var addImports = function (rec, n) {
    if (n instanceof ast.Member)
        return path_1.set(normalizeId(array_1.tail(n.module.module.split('/'))), n.module.module, rec);
...
var addImportsInList = function (rec, l) {
    return l.elements.reduce(addImports, rec);
};
var addImportsInDict = function (rec, d) {
    return d.properties.reduce(function (p, c) { return addImports(p, c.value); }, rec);
};
