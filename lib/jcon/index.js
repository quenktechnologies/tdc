 ...
 */
const newContext = (path, loader) => record_1.merge({ loader, jcon: exports.parse }, {
    path,
    root: path,
    imports: {},
    output: [],
 ...
 */
const compile = (ctx, file) => future_1.doFuture(function* () {
 ...
 */
const value2TS = (ctx, n) => match_1.match(n)
